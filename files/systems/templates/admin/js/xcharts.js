...
(function () {
    ...
    function _getExtents(options, data, xType, yType) {
        ...
        extents = {x: d3.extent(nData, function (d) {
            return d.x
    ...
    var emptyData = [
        []
    ], defaults = {mouseover: function (data, i) {
        ...
        return y
    }, xMin: null, xMax: null, yMin: null, yMax: null, dataFormatX: function (x) {
        return x
    ...
    }, timing: 750, interpolation: "monotone", sortX: function (a, b) {
