    ...
    r(l, [c, d, u], function (e, t, n) {
        ...
        return function (i) {
            ...
            if (i.on("keydown", function (e) {
                ...
                function t(e, t) {
                    for (var r = 0; r < n.types.length; r++)if (n.types[r] == e)return t(n.getData(e)), !0
                }
        ...
        e.add("paste", function (e) {
            ...
            }), e.addMenuItem("pastetext", {text: "Paste as text", selectable: !0, active: a.pasteFormat, onclick: function () {
